...
#include <iostream>
#include <chrono>
#include <algorithm> // Add this include for find_if
...
int main(int argc, char* argv[]) {
    ...
    cout << "Using Proof of Elapsed Time (PoET) consensus algorithm.\n";
    ...
    for(int round = 0; round < totalRounds && !transactionPool.empty(); round++) {
        ...
        // Start PoET round and get the block that was added
        Block addedBlock = startPoETRound(blockchain, minerTxs,attack);
